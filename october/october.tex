...
These were the histograms of the Phi Scales before avoiding the 6th iteration reset.
...
More problematic is that this still doesn't fix the important problem.
